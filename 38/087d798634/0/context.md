...
To test, I need to remove the remi conversation for today from IndexedDB, but it is encrypted. How can I do that?

### Prompt 22

doesn't work in th econsole. Dexie is nt defined

### Prompt 23

I can't paste this into the console and don't feel like typing it myself honestly

### Prompt 24

But my conversation yesterday, Remi and I discussed having 70 days sober, discussed all the things I've been doing.

### Prompt 25

Good morning, Field. Glad you're here on a Sunday.

One day at a time, and you've got one under your belt—that counts. How are you feeling as the week starts fresh?

### Prompt 26

None of what you have done works. roll that change to the system prompt back and we'll just accept that users say during initial setup how many days sober.
